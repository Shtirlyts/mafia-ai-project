...
class RoomManager:
    ...
    def create_room(self, host_name: str, settings: RoomSettings) -> tuple[str, str, MafiaEngine]:
    ...
    def join_room(self, room_code: str, player_name: str) -> Optional[tuple[str, MafiaEngine]]:
        ...
        max_humans = settings.max_players if settings.mode == GameMode.HUMANS_ONLY else (
                    settings.max_players - (settings.ai_count or 0))
